...
export const Route = createFileRoute("/settings")({
  ...
  head: () => ({
    meta: [
      { title: "Configurações · ATLAS AI: 196 — Brasil" },
      { name: "description", content: "Configure Google Drive, Dra. Sinapse e integração da plataforma." },
      { property: "og:title", content: "Configurações · ATLAS AI: 196 — Brasil" },
...
function SettingsPage() {
  ...
  const [form, setForm] = useState({
    drive_folder_id: "",
    drive_root_name: "ATLAS AI: 196 — Brasil - Capturas",
    sinapse_weekday: 0,
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      drive_root_name:
        !s.drive_root_name || /^(SOUL-AI-BRASIL|ATLAS)-Capturas$/i.test(s.drive_root_name)
    ...
    mutationFn: () =>
      saveFn({
        data: {
          ...
          drive_root_name: form.drive_root_name.trim() || "ATLAS AI: 196 — Brasil - Capturas",
